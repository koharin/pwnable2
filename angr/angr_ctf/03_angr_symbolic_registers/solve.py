...
def main():
  ...
  password0 = initial_state.solver.BVS('password0', password0_size_in_bits)

  password1_size_in_bits = 32  # :integer
  password1 = initial_state.solver.BVS('password1', password1_size_in_bits)

  password2_size_in_bits = 32  # :integer
  password2 = initial_state.solver.BVS('password2', password2_size_in_bits)
